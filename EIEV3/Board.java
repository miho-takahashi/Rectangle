...
class Board{
    ...
    public void move(int Rectangle_number,int x,int y){
        System.out.println(Rectangle_number);
            ...
            if(x2>=x1){
                if(x2<=x1+w1 && x1<=x2+w2){
                    if(y2<=y1+h1&&y1<=y2+h2){
                        ...
                        add(x1+w1-x2,y1+h1-y2,x2,y2,str3);
                    }
                }
            }
            else{
                if(x1<=x2+w2 && x2<=x1+w1){
                    if(y1<=y2+h2&&y2<=y1+h1){
                        ...
                        add(x2+w2-x1,y2+h2-y1,x1,y1,str3);
                    }
                }
            }
        }
    ...
    public Color getRGBColor(String a){
        ...
        else if(a.equals("red")) c = new Color(204,0,0,224);
        else{
